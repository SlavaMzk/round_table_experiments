...
import com.slvmk.compose_courses.google.basic.marsphotos.data.MarsPhotosRepository
...
class MarsViewModel(private val marsPhotosRepository: MarsPhotosRepository) : ViewModel() {
    ...
    companion object {
        val Factory: ViewModelProvider.Factory = viewModelFactory {
            initializer {
                val marsPhotosRepository = MarsPhotoActivity.container.marsPhotosRepository
